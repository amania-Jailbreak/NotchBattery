...
- (UIColor *)_batteryFillColor { // Return default or custom fill colors based on charging state
	...
	UIColor *standardColor = overrideColorStandard ? [UIColor colorWithRed:[standardColorDict[@"red"] floatValue] green:[standardColorDict[@"green"] floatValue] blue:[standardColorDict[@"blue"] floatValue] alpha:0.5] : [UIColor colorWithRed:0.4588 green:0.4588 blue:0.4588 alpha:0.5];
	UIColor *lowPowerColor = overrideColorLowPower ? [UIColor colorWithRed:[lowPowerColorDict[@"red"] floatValue] green:[lowPowerColorDict[@"green"] floatValue] blue:[lowPowerColorDict[@"blue"] floatValue] alpha:0.5] : [UIColor colorWithRed:1.00 green:1.00 blue:0.00 alpha:0.5];
	UIColor *chargingColor = overrideColorCharging ? [UIColor colorWithRed:[chargingColorDict[@"red"] floatValue] green:[chargingColorDict[@"green"] floatValue] blue:[chargingColorDict[@"blue"] floatValue] alpha:0.5] : [UIColor colorWithRed:0.00 green:1.00 blue:0.00 alpha:0.5];
	UIColor *criticalColor = overrideColorCritical ? [UIColor colorWithRed:[criticalColorDict[@"red"] floatValue] green:[criticalColorDict[@"green"] floatValue] blue:[criticalColorDict[@"blue"] floatValue] alpha:0.5] : [UIColor colorWithRed:1.00 green:0.00 blue:0.00 alpha:0.5];
